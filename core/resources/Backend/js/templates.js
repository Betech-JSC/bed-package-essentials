export default [
    ...
    },
    {
        ...
        description: "",
        content: `<p></p><div class="flex items-center space-x-6">
        <div class="flex-1">
            <img src="https://via.placeholder.com/600x400.png" class="w-full h-full object-contain my-0" />
        </div>
        <div class="flex-1">
